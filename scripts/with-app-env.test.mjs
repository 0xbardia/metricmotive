...
const HAS_WORKSPACE_APP_ENV = readAppEnv(projectRoot()).VITE_AUTH_ENABLED !== undefined;
...
test("the template ships auth off", { skip: !HAS_WORKSPACE_APP_ENV }, () => {
...
test("the wrapped command runs with the app env applied", { skip: !HAS_WORKSPACE_APP_ENV }, async () => {
...
test("the CLI still runs when invoked through a symlinked path", { skip: !HAS_WORKSPACE_APP_ENV }, async () => {
