/**
 * Guest side of the platform preview postMessage bridge.
 *
 ...
 * under a non-preview parent. Client-only; null during SSR.
 */
...
export function installPreviewHostBridge(
  ...
  const ROOT_STATE_KEY = "__metricMotivePreviewBridgeRoot";
