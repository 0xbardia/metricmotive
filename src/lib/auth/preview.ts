 ...
 * deployed auth settings that override these (see `server.ts`).
 *
 * These MUST equal the broker's preview client id and secret (set in the
 * broker's Vercel env; the broker stores
...
export const AUTH_ISSUER_DEFAULT = "https://auth.grok.me";
